...
static gboolean on_handle_attach (GstVideoSource1 *interface,
...
gst_pulsevideo_sink_class_init (GstPulseVideoSinkClass * klass)
{
  ...
  gst_element_class_set_static_metadata (gstelement_class,
      ...
      "Publish data on DBus by exposing the com.stbtester.VideoSource1 "
...
gst_pulsevideo_sink_init (GstPulseVideoSink * this)
{
  ...
  this->dbus_interface = gst_video_source1_skeleton_new ();
...
static gboolean
on_handle_attach (GstVideoSource1         *interface,
                  ...
                  gpointer                user_data)
{
  ...
  gst_video_source1_complete_attach (
